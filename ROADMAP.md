...
## v1.0.1 (Non-canonical)

- Clarifications and errata only  
- No scope expansion  
- No semantic changes to canonical definitions  

---

## v1.1 (Future, exploratory)

The following items are **provisional** and **subject to formal canonization
only through the CSA governance and versioning process**.
